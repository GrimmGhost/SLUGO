...
<div class="gamesStructure col-md-12">
    ...
    <div class="tournamentList col-md-12">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5303.png" alt="...">
                    <div class="caption">
                        <h3>Thermaltake</h3>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5314.png" alt="...">
                    <div class="caption">
                        <h3>ACM</h3>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5325.png" alt="...">
                    <div class="caption">
                        <h3>PAPA JOHNS</h3>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5336.png" alt="...">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5364.png" alt="...">
                    <div class="caption">
                        <h3>CGB</h3>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4 homePadding">
                <div class="thumbnail" style="  border-radius: 5px;">
                    <img style="  border-radius: 5px;" src="../content/images/homeImages/image5368.png" alt="...">
                    <div class="caption">
                        <h3>FARA</h3>
                    </div>
                </div>
