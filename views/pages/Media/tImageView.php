        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 galleryBlock">
                <div class="thumbnail galleryPadding" style="background-color: transparent">
                    <a class="fancybox" rel="fancybox" href="http://localhost:63342/slugo/views/media.php"><img src="../content/images/slugoCat/cat.png" style="background-color: transparent; border-radius: 5px; height: auto; width: 100%; overflow: hidden"></a>
                </div>
            </div>
            <?php
        $tImagePosition = 0;
