...
require_once 'mail/mailer/PHPMailerAutoload.php';
...
//$mail->Body = 'This is the body of the email!';// normal email
    ...
    $link = "<li><a href='http://localhost:63342/Slugo/views/activate.php?id=" . $data->id . "&email=" . $data->email . "&email_code=" . $data->email_code . "'>Click Here</a></li>";
    $url = "<li> href='http://localhost:63342/Slugo/views/activate.php?id=" . $data->id . "&email=" . $data->email . "&email_code=" . $data->email_code . "</li>";
...
//$mail->Body = 'This is the body of the email!';// normal email
    ...
    $link = "<li><a href='http://localhost:63342/Slugo/views/resetPassword.php?email=" . $data->email . "&username=" . $data->username. "&resetPassCode=" .$data->resetPassCode."'>Click Here</a></li>";
    $url = "<li> href='http://localhost:63342/Slugo/views/resetPassword.php?email=" . $data->email . "&username=" . $data->username. "&resetPassCode=" .$data->resetPassCode."'</li>";
