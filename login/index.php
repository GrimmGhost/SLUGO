    ...
    <div class="gamesStructure col-md-12">
        ...
        <div class="">
            <form action ="" method="post">
                <p>Hello, <a style="color: #333333" href="../views/profile.php?user=<?php echo escape($user->data()->username); ?>"><?php echo escape($user->data()->first_name); ?></a>!</p>
                <div class="accountImage">
                    <img src="../content/accountImages/<?php echo escape($user->data()->avatar); ?>">
                </div>
                <!-- ../views/updateDetails.php -->
                <a href="../login/errors/404.php" style="background-color: transparent; text-decoration: none">
                ...
                <a href="../views/changepass.php" style="background-color: transparent; text-decoration: none">
                    <div class="" style="text-align: center; background-color: cornflowerblue; padding: 10px; border-radius: 5px; color: #ffffff; margin-top: 15px; text-decoration: none">
                        Change password
                    </div>
                </a>
...
{
    echo '<p>You need to <a href="../views/login.php">log in</a>  or <a href="../views/register.php">register</a></p>';
}
